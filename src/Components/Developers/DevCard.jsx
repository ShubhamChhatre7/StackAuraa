  ...
  return (
    <StyledWrapper>
      <div className="card">
        ...
        <div className="card-title">{props.name} <br />
          <span>{props.dev}</span>
        </div>
